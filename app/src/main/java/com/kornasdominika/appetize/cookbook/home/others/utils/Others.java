package com.kornasdominika.appetize.cookbook.home.others.utils;
...
import com.kornasdominika.appetize.cookbook.home.others.ui.IOthersFragment;
...
public class Others implements IOthers{

    private IOthersFragment othersFragment;
    ...
    public Others(IOthersFragment othersFragment) {
    ...
    @Override
    public void getAllOthersList(String category) {
        ...
        call.enqueue(new Callback<List<Recipe>>() {
            ...
            public void onResponse(@NotNull Call<List<Recipe>> call, @NotNull Response<List<Recipe>> response) {
                if (response.isSuccessful()) {
                    ...
                    if(recipesList.isEmpty()){
                        ...
                        othersFragment.checkIfRecipesExists(true, null);
                    }
                }
            }
            ...
            public void onFailure(@NotNull Call<List<Recipe>> call, @NotNull Throwable t) {
                othersFragment.checkIfRecipesExists(false, "Error during download of meals receipts");
            }
        });
    }
